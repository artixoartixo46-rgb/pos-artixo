...
const items = [
  ...
  { title: "Purchase History", url: "/credit-purchase-history", icon: History, ownerOnly: false },
  { title: "Product Receiving", url: "/product-receiving", icon: TruckIcon, ownerOnly: true },
  { title: "Product Inventory", url: "/product-inventory", icon: Archive, ownerOnly: false },
  { title: "Stock Take", url: "/stock-take", icon: ClipboardCheck, ownerOnly: false },
  { title: "Returns & Refunds", url: "/returns", icon: Undo2, ownerOnly: false },
  { title: "QR Code Print", url: "/barcode-print", icon: QrCode, ownerOnly: false },
  { title: "Reports", url: "/reports", icon: BarChart3, ownerOnly: true },
  { title: "Demand Forecast", url: "/demand-forecast", icon: Sparkles, ownerOnly: false },
